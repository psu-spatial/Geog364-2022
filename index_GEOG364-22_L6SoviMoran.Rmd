...
We are now going to do a Moran's I analysis of the data, which we will cover in Wednesday's lecture
...
c. What is 1st/2nd order autocorrelation are and what you expect for this dataset <br>

2. Converting the data from sf into sp. (bonus for tidy varible names) <br>
...
5. Creating a Moran's scatterplot AND FULLY INTERPRETING IN THE TEXT. For example, 
 a. what would you expect for positive/negative etc - 
 b. do you see what you are expecting. 
 c. What assumptions did you make and are they correct (outliers, linearity..)
 d. What do you conclude?

6. Conducting AND FULLY INTERPRETING IN THE TEXT a Moran's Hypothesis Test on the dataset.
...
People who use this section get better grades... YOU GET MORE MARKS FOR A REALLY NEAT AND THOUGHTFUL REPORT.
