...
1.  On a windows machine, go to: <https://cloud.r-project.org/bin/windows/base/> , download R v 4.2.1 and double click to install (click next through all the options)

2.  On a Mac, go to: <https://cloud.r-project.org/bin/macosx/> ,download the R v 4.2.1 package and double click to install (click next through all the options)
...
```{r, Tut1Fig6, echo=FALSE,out.width="90%",fig.align='centre'}
...
**IMPORTANT!  In an easy to access place on your computer, make a folder called GEOG-364.  This is where ALL your labs are going to live**
...
```{r, tut2afig5, echo=FALSE, fig.cap="Note, in this book you might see a few GEOG-364s instead of GEOG-364s"}
...
These tutorials show more about to add inline code and to practice.
