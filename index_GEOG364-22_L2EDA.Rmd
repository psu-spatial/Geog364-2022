...
2. Use helpfiles to make me a "Quick Thematic Map (qtm)" of a city of your choice (hint, start by googling *""Quick Thematic Map" QTM documentation R*) then work through my tutorial above.   Hint, the command is called qtm.. 
